...
import { SiNextdotjs, SiTailwindcss, SiTypescript, SiExpress, SiMongodb, SiMongoose } from "react-icons/si";
...
const Skills = () => {
    const frontendSkills = [
        ...
        { name: "HTML & CSS", icon: <FaHtml5 className="text-orange-500" />, cssIcon: <FaCss3Alt className="text-blue-500" /> },
    ...
    return (
        <div className="p-10 bg-gray-900 text-white">
            ...
            <div className="mt-10 grid grid-cols-1 gap-12">
                {/* Frontend Section */}
                <div>
                    <h3 className="text-3xl font-semibold mb-4 text-gray-300">Frontend</h3>
